  ...
  return (
    <View style={[style]}>
      ...
      <TextInput
        ...
        returnKeyType={inputProps.multiline ? undefined : inputProps.returnKeyType || remote.props?.returnKeyType}
        onSubmitEditing={inputProps.multiline ? undefined : inputProps.onSubmitEditing || remote.props?.onSubmitEditing}
      />
      {after}
    </View>
  );
